...
#define COLD_DAMAGE_LEVEL_2 3 //Amount of damage applied when your body temperature passes the 200K point
#define COLD_DAMAGE_LEVEL_3 6 //Amount of damage applied when your body temperature passes the 120K point
...
#define COLD_GAS_DAMAGE_LEVEL_2 3   //Amount of damage applied when the current breath's temperature passes the 200K point
#define COLD_GAS_DAMAGE_LEVEL_3 6  //Amount of damage applied when the current breath's temperature passes the 120K point
